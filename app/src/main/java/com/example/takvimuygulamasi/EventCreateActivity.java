...
public class EventCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvStartEventDate = findViewById(R.id.tv_startEventDate);
        tvEndEventDate = findViewById(R.id.tv_endEventDate);
        tvLocation = findViewById(R.id.tv_location);
        ivStartEventDate = findViewById(R.id.iv_startEventDate);
        ivEndEventDate = findViewById(R.id.iv_endEventDate);
        ivLocation = findViewById(R.id.iv_location);
        btnSaveEvent = findViewById(R.id.btn_saveEvent);
        btnShareEvent = findViewById(R.id.btn_shareEvent);
        ivBackMain = findViewById(R.id.backMain);

        cbReminder = findViewById(R.id.cb_reminder);
        tvReminderTitle = findViewById(R.id.tv_reminderTitle);
        tvReminderDate = findViewById(R.id.tv_reminderDate);
        tvReminderTime = findViewById(R.id.tv_reminderTime);
        ivReminderDate = findViewById(R.id.iv_reminderDate);
        ivReminderTime = findViewById(R.id.iv_reminderTime);
        btnReminderAdd = findViewById(R.id.btn_reminderAdd);
        spFreqReminder = findViewById(R.id.sp_freqReminder);
        reminderLayout = findViewById(R.id.reminderLayout);
        tvFreqText = findViewById(R.id.tv_freqText);
        ...
        ivBackMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backMain = new Intent(EventCreateActivity.this, MainActivity.class);
        ...
        ivReminderTime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePicker = new TimePickerDialog(EventCreateActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        ivReminderDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePicker = new DatePickerDialog(EventCreateActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btnReminderAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(EventCreateActivity.this, BroadcastReceiver.class);
                ...
                PendingIntent pendingIntent = PendingIntent.getBroadcast(EventCreateActivity.this, reqCode, myIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                ...
                try {
                    if (idTemp == -1) {
                        Toast.makeText(EventCreateActivity.this, "Önce etkinlik oluşturun", Toast.LENGTH_SHORT).show();
                    } else {
                        dbHelper.createReminder(idTemp, reminderModel);
                    }
                } catch (Exception e) {
                    Toast.makeText(EventCreateActivity.this, "Hatırlatıcı Oluşturulamadı", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
        ...
        ivLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(EventCreateActivity.this
                        , Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    getLocation();
                } else {
                    ActivityCompat.requestPermissions(EventCreateActivity.this
                            , new String[]{
        ...
        btnSaveEvent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(strName) || TextUtils.isEmpty(strDesc)) {
                    etEventName.setError("Boş Alanları Doldurun Lütfen");
                    etEventDescription.setError("Boş Alanları Doldurun Lütfen");
                    return;
                } else {
                    try {
                        idTemp = dbHelper.createEvent(eventModel);
                    } catch (Exception e) {
                        Toast.makeText(EventCreateActivity.this, "Etkinlik oluşturulamadı", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
        ...
        btnShareEvent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(strName) || TextUtils.isEmpty(strDesc)) {
                    ...
                    String shareBody = "Etkinlik Adı: " + etEventName.getText().toString() +
                            " Etkinlik Açıklaması: " + etEventDescription.getText().toString();
                    String shareSub = "Konum: " + "http://www.google.com/maps/place/" +
                            s_Latitude + "," + s_Longitude;
                    ;
    ...
    protected void onStart() {
        ...
        final LinearLayout newReminderLayout = findViewById(R.id.createEvent);
